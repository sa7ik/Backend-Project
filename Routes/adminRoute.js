...
adminRoutes.post("/admin/add",adminAuth,uploadImage,tryCatch(adminController.addProduct))
adminRoutes.put("/admin/update/:id",adminAuth,uploadImage,tryCatch(adminController.updateProduct))
